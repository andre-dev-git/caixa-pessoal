...
export default function SubscriptionsPage() {
  ...
  async function cancel(id: string) {
    ...
    toast.success("Assinatura cancelada (histórico preservado)");
    load();
  }
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-600">
          Uma assinatura gera ocorrências periódicas até ser cancelada. Cancelar
            ...
            <CardContent className="flex flex-col gap-3 pt-4 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="text-sm text-slate-600">
                  ...
                  {s.startDate}
                  {s.cancelledAt ? ` · cancelada em ${s.cancelledAt}` : ""}
                </p>
                <p className="text-xs text-slate-500">
                  {s.entries.length} ocorrência(s) materializada(s)
                </p>
              </div>
